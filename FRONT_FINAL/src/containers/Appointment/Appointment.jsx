...
export default function Appointment() {
      ...
      filtered = filtered.filter((appointment) => {
        ...
        if (role === "Admin") {
          const user = users.find(
            (user) => user._id === appointment?.patientID
          );
  ...
  const upcomingAppointments = appointments
    .filter(
      (a) =>
        a?.status === "Approved" &&
        dayjs(a?.date).isAfter(dayjs()) &&
        dayjs(a?.date).isBefore(dayjs().add(7, "day"))
    )
            ...
            <CardContent sx={{ p: 4 }}>
              <Box sx={{ display: "flex", alignItems: "center", gap: 3 }}>
                ...
                <Box sx={{ flex: 1 }}>
                  ...
                  >
                    {t(
                      "Upgrade to premium to unlock appointment scheduling and get priority access to doctors."
                    )}
                  </Typography>
                  <Button
                    variant="contained"
                  ...
                  <Table>
                    ...
                    <TableBody>
                      {paginatedAppointments.map((appointment) => {
                        ...
                        const { color, icon, bgColor } = getStatusChipProps(
                          appointment?.status
                        );
                ...
                <Grid item xs={12} md={4} key={appointment?._id}>
                  ...
                  >
                    <CardContent sx={{ p: 3 }}>
                      ...
                      >
                        <AccessTimeIcon
                          sx={{ fontSize: 16, color: "#ec4899", mr: 1 }}
                        />
                        <Typography
                          variant="body2"
                          color="rgba(255, 255, 255, 0.7)"
                      ...
                      <Divider
                        sx={{ my: 2, borderColor: "rgba(139, 92, 246, 0.1)" }}
                      />
